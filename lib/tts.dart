              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    //   border: Border(top: BorderSide(color: Colors.white),bottom: BorderSide(color: Colors.white),left: BorderSide(color: Colors.white),right: BorderSide(color: Colors.white))
                    // ),
                    child: TextField(
